...
- translation_unit :               //dormouse:椤剁骇妯″潡锛屼竴鍒囩殑寮€濮�
  - module_declaration
- module_declaration :   //鍘绘帀浜唒arameter_port_list
...
- port_reference :
	- port_identifier[ **[** constant_range_expression **]**  ]   //这里决定ident的哪几位供给
- port_declaration: 
	- input_declaration | output_declaration | inout_declaration  
//by dormouse : 鑰冭檻鍒犳帀inout
- module_item :
	- port_declaration **;**
...
- net_declaration :
	- **wire** [ **signed** ] [ range ] list_of_net_decl_assignments_or_identifiers ;  //delay strength vector 鍘绘帀浜�
- real_declaration :
...
- block_item_declaration :  //涔熻鐢ㄤ笉鍒帮紝鏆傛椂鍒犳帀銆傝娉曡markdown鍘熸枃  
...
- input_terminal :
  - expression
- input_or_output_terminal :   //expression_2 涓嶅お鎳傜粨鏋勶紝涔熸病鏈夊湪鏈枃缁欏嚭
  - expression_2   
...
- generate_region :
	- **generate** { module_or_generate_item } **endgenerate**  //dormouse涔熻浼氬幓鎺�
  
- genvar_declaration :
  - **genvar** list_of_genvar_identifiers **;**  //dormouse涔熻浼氬幓鎺�
...
- hierarchical_event_identifier : //鍙兘鐢ㄤ笉鍒帮紝杩欓噷涓嶇粰鍑哄唴瀹癸紝璇﹁markdown鍘熸枃
...
//DORMOUSE
	鑰冭檻鍘绘帀genvar   
	鑰冭檻鍘绘帀seq_block涓殑block_identifier 琛ㄨ堪  
	 鑰冭檻鍘绘帀constant  
//DORMOU SE  
...
//removed     
	...
	module_or_udp_instantiation  // module璇彞鎴栬€卽dp瀹炰緥  
	specify_block  
